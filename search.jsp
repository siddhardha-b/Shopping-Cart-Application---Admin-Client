...
%>
 <%
                                ...
                                ResultSet rs = st.executeQuery("select * from product where website like '%"+ca+"%' or pname like '%"+ca+"%' or bname like '%"+ca+"%' or price like '%"+ca+"%'");
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                     ...
                                     <a href="category.jsp?ca=Cricket">Cricket<a/>
									 <a href="category.jsp?ca=Basket">Basket Ball<a/>
									 <a href="category.jsp?ca=Volley">Volley Ball<a/>
									 <a href="category.jsp?ca=Soccer">Soccer<a/>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <p class="buttons">
                                        <a href="detail.jsp?id=<%=rs.getString(1)%>" class="btn btn-default">View detail</a>
