...
%>
 <%
                                ...
                                ResultSet rs = st.executeQuery("select * from product where id='"+ca+"'");
    ...
    <div class="container">
                 <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                        ...
                        <th style="background-color: white">Brand Name</th>
                        <th style="background-color: white">Price</th>
                        <th style="background-color: white">Validity</th>
                       ...
                       <tr>
                        <%
                                ...
                                while (rs.next()) {%>
                       					   <td><img src="./img/<%=rs.getString("iname")%>" ></td>
